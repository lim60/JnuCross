package com.finsupplychain.car.contractwrapper.ethereum;
...
/**
 * @author jessy-js
 * @ClassName ImpawnLoadEthWrapper
 * @Version V1.0
 * @Description
 */
public class ImpawnLoadEthWrapper {

    private static EthereumWrapper ethereumWrapper;

    static {
        try {
            ethereumWrapper = EthereumWrapper.build();
    ...
    public void deploy() throws Exception {
        ...
        /*0x8f321775f568ee453a12a5f9f71b31e208e6326e 23-08-31--21:34*/
    }
    ...
    public BigInteger uploadLoadRequestTC(ImpawnLoanRequestOC impawnLoanRequestOC) throws Exception {
        ...
        FunctionResult functionResult = ethereumWrapper.send(abi, "ImpawnLoan",contractAddr, "createImpawnLoanRequest", args, false, null, true);
    ...
    public String saveLoadProposalOC(BigInteger loadOCIndex, String orderState, String taxState,
        ...
        FunctionResult functionResult = ethereumWrapper.send(abi, "ImpawnLoan",contractAddr, "ifImpawnLoan", args, false, null, true);
        System.out.println("----- txHash = " + functionResult.transactionHash);
    ...
    public String uploadSignedContractOC(BigInteger loadOCIndex, String contractSignedDigest, String creditAgreementDigest,
        ...
        FunctionResult functionResult = ethereumWrapper.send(abi, "ImpawnLoan",contractAddr, "signContractForImpawnLoan", args, false, null, true);
        System.out.println("----- txHash = " + functionResult.transactionHash);
    ...
    public void queryLodStateOC(BigInteger loadOCIndex) throws Exception {
        ...
        FunctionResult result1 = ethereumWrapper.call(abi, "ImpawnLoan",contractAddr, "queryImpawnLoanState", callArgs);
    ...
    public String saveAllowedLoadOC(BigInteger loadOCIndex, String statement, String clientAccount,
        ...
        FunctionResult functionResult = ethereumWrapper.send(abi, "ImpawnLoan",contractAddr, "makeImpawnLoan", args, false, null, true);
        System.out.println("----- txHash = " + functionResult.transactionHash);
    ...
    public void saveRefundedLoadOC(BigInteger loadOCIndex, String statement, String clientAccount,
                                   String bankAccount) throws Exception {
        List<String> args = new ArrayList<String>();
        args.add(TypeEncoder.encode(new Uint256(loadOCIndex)));
        args.add(TypeEncoder.encode(new Utf8String(statement)));
        ...
        FunctionResult functionResult = ethereumWrapper.send(abi, "ImpawnLoan",contractAddr, "refundImpawnLoan", args, false, null, true);
        System.out.println("----- txHash = " + functionResult.transactionHash);
//        String loadResult = ((Type) functionResult.result.get(0)).toString();
        System.out.println("proposalResult------" + functionResult.result);
    }
    ...
    public String saveUnsignedLoadOC(BigInteger loadOCIndex, String unsignedDigest) throws Exception {
        ...
        FunctionResult functionResult = ethereumWrapper.send(abi, "ImpawnLoan",contractAddr, "unsignImpawnLoan", args, false, null, true);
        System.out.println("----- txHash = " + functionResult.transactionHash);
        String loadResult = ((Type) functionResult.result.get(1)).toString();
        System.out.println("proposalResult------" + loadResult);
        return loadResult;
    ...
    public void test() throws Exception {
        ...
        queryLodStateOC(BigInteger.valueOf(0));
    }
}
