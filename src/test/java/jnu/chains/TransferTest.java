...
//        System.out.println("Balance : " + ethereumWrapper.getBalance());
    ...
    public void XuperDeployAndSendTest() throws Exception{
        ...
        String contractName = "SimpleStorage8";
//
//        System.out.println("------");
//        System.out.println(xuperChainWrapper.getBalance());

        // xuperchain 部署合约 {contractAccount=XC1234567890123456@xuper, txHash=8d7a273b6d5628b9f87a184f3f850d02f6e88324cd06d6403970a8b58809c8e8}
